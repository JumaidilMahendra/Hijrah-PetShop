<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="about.php"> <i class="fas fa-angle-right"></i> Produk</a>
         <!-- <a href="shop.php"> <i class="fas fa-angle-right"></i> shop</a> -->
         <a href="jasa.php"> <i class="fas fa-angle-right"></i> Jasa</a>
   ...
   <div class="credit">&copy; copyright Jumaidil Mahendra | all rights reserved!</div>
